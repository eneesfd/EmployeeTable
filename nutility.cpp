...
std::string rname()
{
    ...
    return pnames[Irand(0, sizeof(pnames) / sizeof(pnames[0]) - 1)()];
}
//--------------------------------------------------
std::string getRandomDepartment()
{
    const char *const departments[] = {
        "HR", "IT", "Finance", "Marketing", "Operations", "Sales", "Engineering", "Customer Support",
    };

    return departments[Irand(0, sizeof(departments) / sizeof(departments[0]) - 1)()];
}
//--------------------------------------------------
std::string rfname()
{
...
"savaskan", "sivri"
    ...
    return pfnames[Irand(0, sizeof(pfnames) / sizeof(pfnames[0]) - 1)()];
}
//--------------------------------------------------
//--------------------------------------------------
std::string rtown()
...
"hatay", };
    return ptowns[Irand(0, sizeof(ptowns) / sizeof(ptowns[0]) - 1)()];
}
//--------------------------------------------------
//--------------------------------------------------
